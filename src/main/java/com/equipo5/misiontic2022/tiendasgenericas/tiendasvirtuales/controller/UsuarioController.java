package com.equipo5.misiontic2022.tiendasgenericas.tiendasvirtuales.controller;
...
import com.equipo5.misiontic2022.tiendasgenericas.tiendasvirtuales.repository.UsuarioRepository;
...
public class UsuarioController {
	...
	if (usuarioData.isPresent()) {
		...
		_usuario.setUsername(user.getPassword());
